...
- `bridge/` — explain what lives here and when agents should edit it.
...
- `coverage.json/` — explain what lives here and when agents should edit it.
- `cpp/` — explain what lives here and when agents should edit it.
